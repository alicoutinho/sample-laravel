...
@section('main')
    <div id="content" class="col-sm-9">
        ...
        <div class="row products-category">
            @foreach($category->product()->paginate(3) as $pro)
            <div class="product-layout product-grid col-lg-5ths col-md-5ths col-sm-3 col-xs-12">
                <div class="product-thumb">
                    <div class="image"><a href="product.html"><img src="{{$pro->image}}" alt=" کتاب آموزش باغبانی " title=" کتاب آموزش باغبانی " class="img-responsive"></a></div>
                    <div>
                        <div class="caption">
                            ...
                            <p class="price"> <span class="price-new">{{$pro->price}} تومان</span> <span class="price-old">120000 تومان</span> <span class="saving">-26%</span> <span class="price-tax">بدون مالیات : 90000 تومان</span> </p>
                        </div>
