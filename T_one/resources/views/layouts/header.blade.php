            ...
            <div class="container">
                <div class="table-container">
                    ...
                    <div class="col-table-cell col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        @auth()
                        <div id="cart">
                            <a href="/basket" id="card-id" type="button" data-toggle="dropdown" data-loading-text="Loading..."
                                    class="heading dropdown-toggle">
                                <span class="cart-icon pull-left flip"></span>
                                @if($baskets != null && count($baskets) >0)
                                    <span id="cart-total"> {{count($baskets)}}آیتم - 132000 تومان</span></a>
                                @endif
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <div>
                                        ...
                                        <p class="checkout"><a href="/basket" class="btn btn-primary"><i
            ...
            <div class="row">
                ...
                <aside id="column-left" class="col-sm-3 hidden-xs">
                    ...
                    <div class="box-category">
                        <ul id="cat_accordion">
                            @foreach($cats as $cat)
                            <li><a href="{{$cat->url}}">{{$cat->title_fa}}</a> <span class="down"></span>
                                <ul>
                    ...
                    <div class="side-item">
                        ...
                        <div class="product-thumb clearfix">
                            <div class="image"><a href="product.html">
                                    <img src="{{ $product->image }}" class="img-responsive"/></a></div>
                            <div class="caption">
                                <h4><a href="product.html">{{ $product->name }}</a></h4>
                                <p class="price"><span class="price-new">110000 تومان</span> <span class="price-old">{{$product->price}} تومان</span>
